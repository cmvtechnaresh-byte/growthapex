  ...
  return (
    <footer style={{ background: '#ffffff', borderTop: '1px solid rgba(0,0,0,0.05)', paddingTop: '6rem', paddingBottom: '2rem' }}>
      <div className="container" style={{ maxWidth: '1200px' }}>
        ...
        <div className="grid grid-4" style={{ gap: '4rem', marginBottom: '4rem', gridTemplateColumns: '2fr 1fr 1fr 1.5fr' }}>
          
          {/* Column 1: Brand */}
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
            <img src="/logo.png" alt="GrowthApex Logo" style={{ height: '80px', width: 'fit-content' }} onError={(e) => { e.target.style.display = 'none'; }} />
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
            ...
            <a href="#contact" style={{ color: '#64748b', textDecoration: 'none', fontWeight: 500, transition: 'color 0.2s' }} onMouseOver={e => e.target.style.color='var(--primary)'} onMouseOut={e => e.target.style.color='#64748b'}>Contact Support</a>
          </div>
      ...
      <style>{"\
        @media (max-width: 968px) {\
          footer .grid-4 { grid-template-columns: 1fr 1fr !important; gap: 3rem !important; }\
        }\
